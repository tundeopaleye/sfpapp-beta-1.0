...
<div style="height:30em; width:auto; overflow: hidden; border:3px solid #f57f20; background-color: #efefff;" align="center">{!!HTML::image("images/$caption->thumbnail",'', array('width'=>'auto','height'=>'100%')) !!}</div>
