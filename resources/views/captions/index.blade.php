...
<!--<div class="row">-->
	...
	<div class="row clearfix">
	           ...
	           <h5 style="color: #ff8a00;">Captioned by: {{ $caption->user->name }}</h5>
	            <p><div style="height:10em; overflow: hidden; border:3px solid #ff8a00; "><a href="/captions/{{$caption->id}}">{!!HTML::image("https://sfpapp.s3.amazonaws.com/thumbnails/$caption->thumbnail",'', array('width'=>'100%','height'=>'auto')) !!}</a></div></p>
	            ...
	            <span style="color:#ff8a00;"> {{ $caption->reposts->count() }} Retells</span> | <span style="color:#ff8a00;">{{ $caption->comments->count() }} Comment(s)</span> | {{ $caption->likes->count() }} likes<br>
