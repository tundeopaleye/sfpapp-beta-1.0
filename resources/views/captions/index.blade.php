...
<!--<div class="row">-->
	...
	<div class="row clearfix">
	           ...
	           <h5 style="color: #f57f20;">Captioned by: {{ $caption->user->name }}</h5>
	            <p><div style="height:10em; overflow: hidden; border:3px solid #f57f20; "><a href="/captions/{{$caption->id}}">{!!HTML::image("home/forge/default/releases/20150717172929/public/thumbnails/$caption->thumbnail",'', array('width'=>'100%','height'=>'auto')) !!}</a></div></p>
